...
const Index = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setForm({ ...form, uniqueNumber });
    toast({
      title: "Form submitted.",
      description: `We've received your sample request. Your tracking number is ${uniqueNumber}. Please use the following address for your sample shipment:\nCyklop CSC Att.: SampleLab M.Slot ${uniqueNumber}\nWilhelm Röntgenstraat 10\n8013NC\nZwolle\nNederland`,
      status: "success",
      duration: 5000,
      isClosable: true,
    });
